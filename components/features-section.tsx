...
function FeatureCard({ icon, title, description, preview }) {
  return (
    <div className="bg-white rounded-xl border border-slate-200 overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1 group">
      <div className="p-6">
      ...
      <div className="border-t border-slate-200 bg-slate-50 p-4 h-64 overflow-hidden">
